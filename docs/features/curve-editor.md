...
:::note
このページは使い方の**ガイド**です。各カーブプロパティ（`DampingCurveData` ほか）のリファレンスは [物理パラメータ](/docs/parameters/physics) を参照してください。
:::
...
![カーブによる根元→先端の変化](/img/generated/curve-root-to-tip.svg)

*ボーンチェーンの根元から先端へ向かってパラメータ（例: Stiffness）を滑らかに変化させる様子*
